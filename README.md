...
- `css/styles.css?v=3.5.12`
- `css/filters.css?v=3.5.12`
- `js/app.js?v=3.5.12`
- `js/proyecto.js?v=3.5.12`
- `js/blog.js?v=3.5.12`
- `js/admin.js?v=3.5.12`
- `data/projects.json?v=3.5.12`
- `data/lang.json?v=3.5.12`
- `data/blog.json?v=3.5.12`
