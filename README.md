...
- `css/styles.css?v=3.5.11`
- `css/filters.css?v=3.5.11`
- `js/app.js?v=3.5.11`
- `js/proyecto.js?v=3.5.11`
- `js/blog.js?v=3.5.11`
- `js/admin.js?v=3.5.11`
- `data/projects.json?v=3.5.11`
- `data/lang.json?v=3.5.11`
- `data/blog.json?v=3.5.11`
