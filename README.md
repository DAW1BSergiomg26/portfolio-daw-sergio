...
Versión actual estable: `v3.7.3`.

Ejemplo:

- `css/styles.css?v=3.7.3`
- `css/filters.css?v=3.7.3`
- `js/app.js?v=3.7.3`
- `js/proyecto.js?v=3.7.3`
- `js/blog.js?v=3.7.3`
- `js/admin.js?v=3.7.3`
- `data/projects.json?v=3.7.3`
- `data/lang.json?v=3.7.3`
- `data/blog.json?v=3.7.3`
